...
public class Recver {
    ...
    @RabbitListener(queues = {RabbitMQConfig.TOPIC_QUEUE_NORMAL})
    public void listenerQueue(Message message, Channel channel) throws InterruptedException {
        ...
        try {
            ...
            try {
                 ...
                 *  */
                channel.basicNack(deliveryTag, true, false);// 该方法针对多个消息
                // channel.basicReject(deliveryTag, false);// 该方法针对单个消息
